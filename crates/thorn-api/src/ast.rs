...
impl_range!(
    Module,
    StmtFunctionDef, StmtClassDef, StmtReturn, StmtAssign, StmtAnnAssign,
    StmtAugAssign, StmtFor, StmtWhile, StmtIf, StmtWith, StmtRaise, StmtTry,
    StmtAssert, StmtImport, StmtImportFrom, StmtGlobal, StmtNonlocal, StmtExpr,
    StmtPass, StmtBreak, StmtContinue, StmtDelete,
    ElifElseClause, WithItem, ExceptHandler, Alias,
    ExprBoolOp, ExprNamed, ExprBinOp, ExprUnaryOp, ExprLambda, ExprIf,
    ExprDict, ExprSet, ExprListComp, ExprSetComp, ExprDictComp, ExprGenerator,
    ExprAwait, ExprYield, ExprYieldFrom, ExprCompare, ExprCall,
    ExprFString, ExprStringLiteral, ExprBytesLiteral, ExprNumberLiteral,
    ExprBooleanLiteral, ExprNoneLiteral, ExprEllipsisLiteral,
    ExprAttribute, ExprSubscript, ExprStarred, ExprName, ExprList, ExprTuple,
    Arguments, Keyword, Parameters, Parameter, Comprehension, FStringExpression,
);
